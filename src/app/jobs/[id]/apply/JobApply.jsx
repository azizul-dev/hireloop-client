        ...
        >
          ...
          <div className="flex gap-3 pt-2">
            <Button
              type="submit"
              isLoading={isLoading}
              className="flex-1 py-3 bg-white text-black font-semibold rounded-xl hover:bg-neutral-200 transition-colors text-sm"
            >
              Submit Application
            </Button>
            <Button
              type="reset"
              className="px-6 py-3 bg-transparent border border-neutral-800 text-neutral-400 font-medium rounded-xl hover:bg-neutral-900 transition-colors text-sm"
            >
              Reset
            </Button>
          </div>
